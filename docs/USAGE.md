...
本文描述 0.1.2，用户可安装对应 Release 包后测试。改动摘要见 [0.1.2 说明](RELEASE-0.1.2.md)。0.1.1 的范围见 [旧版说明](RELEASE-0.1.1.md)，此前实测见 [验收记录](VALIDATION.md)。本次未完成验收见 [候选记录](UX-CANDIDATE.md)，不能把旧版实测当作本版本已通过实机验收。
