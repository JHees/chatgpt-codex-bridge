...
本文描述 0.1.3，完整折叠与移除联动需要原生 Windows Loader 0.5.12 或更新版本。改动摘要见 [0.1.3 说明](RELEASE-0.1.3.md)，本轮测试范围见 [体验验证记录](UX-ITERATION.md)。此前版本与模型实测见 [0.1.2 说明](RELEASE-0.1.2.md) 和 [验收记录](VALIDATION.md)，不把旧版实测当作新增功能的实机验收。
